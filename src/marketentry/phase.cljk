(ns marketentry.phase
  "Phase 0->3 staged rollout for the KHM market-entry compliance
  actor.
  ...
  real QIP/portal package and submitting a real QIP/portal
  registration are the two real-world acts this actor performs; both
  are always a human market-entry operator's call.
