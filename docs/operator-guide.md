...
- named referral relationship with Cambodian-licensed counsel or a
...
a working referral relationship with Cambodian-licensed counsel or a
registered agent for whatever licensed representation the law of
Cambodia requires for actual public-procurement filings.
